<div class="w-3/12 p-6 bg-white rounded-lg shadow-md mt-8">
    ...
    <div class="mb-4">
        <label class="block">
            <span class="text-gray-700">Emails to Share With:</span>
            <input type="text" wire:model="sharedEmails" class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Comma separated emails...">
        </label>
    </div>
    ...
    <div class="mb-4">
        <label class="block">
            ...
            <select wire:model="type" class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                <option value="password">Password</option>
                <option value="uuid">UUID</option>
                <option value="cloak_key">Cloak Key</option>
            </select>
        </label>
    </div>
